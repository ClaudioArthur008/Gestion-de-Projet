...
#include "../../gestion_de_l_intervantion/projet.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_projet_t, stringdata) + ofs \
...
const QMetaObject projet::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_projet.data,
      qt_meta_data_projet,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_projet.stringdata))
